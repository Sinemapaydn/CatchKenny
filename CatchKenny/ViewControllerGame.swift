...
//  CatchKenny
//
//  Created by SinemApaydın on 13.08.2023.
//
...
class ViewControllerGame: UIViewController {
    ...
    @objc func countDown(){
        ...
        if counter == 0 {
            ...
            let okButton = UIAlertAction(title: "No", style: .cancel) { (UIAlertAction) in
                // Back prev page
            ...
            let replayButton = UIAlertAction(title: "Yes ", style: UIAlertAction.Style.default) {
                (UIAlertAction) in
